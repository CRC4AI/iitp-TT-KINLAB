...
class MyAppWindow(QMainWindow, form_class):
    def __init__(self):
        ...
        self.real_data_list = os.listdir('./data/real/')
        self.real_data_list = ['real/' + f for f in self.real_data_list]
        self.synth_data_list = os.listdir('./data/synth/')
        self.synth_data_list = ['synth/' + f for f in self.synth_data_list]
    ...
    def save_data(self):
        ...
        data = {"info":info_data, "data":self.data_list, "test":self.test_tab.get_data(), "bounding_box":self.answer_tab.get_data()}
        name = info_data["name"]
